...
const images = {
  hero: "/agency_hero_workspace.png",
  bento1: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=800&auto=format&fit=crop",
  bento2: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=800&auto=format&fit=crop",
  bento3: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?q=80&w=1600&auto=format&fit=crop",
  process: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1920&auto=format&fit=crop",
  results: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1920&auto=format&fit=crop",
...
export default function LandingPage() {
  return (
    <main className="flex-1 w-full flex flex-col items-center bg-black text-white font-sans selection:bg-orange-500 selection:text-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[90vh] md:min-h-screen flex flex-col justify-center items-center px-4 md:px-12 py-20 overflow-hidden">
        {/* Background Image Strict Grayscale Layer */}
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-black/60 z-10" />
          <img
            src={images.hero}
            alt="Premium Agency Workspace"
            className="w-full h-full object-cover filter grayscale contrast-110 opacity-70 scale-105"
          />
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-start justify-center flex-1">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-orange-500/30 bg-black/40 backdrop-blur-md text-orange-500 uppercase tracking-widest text-xs font-bold mb-8 shadow-[0_0_15px_rgba(249,115,22,0.2)]"
          >
            <ShieldCheck size={16} />
          ...
          <motion.h1
            ...
            className="text-5xl md:text-8xl lg:text-[7.5rem] font-black leading-[0.9] tracking-tighter uppercase max-w-5xl drop-shadow-[0_5px_15px_rgba(0,0,0,0.5)]"
          >
            Scale Your <br />
            Business <br />
            <span className="text-orange-500 block mt-2 drop-shadow-[0_0_30px_rgba(249,115,22,0.3)]">With Precision.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-3xl text-gray-300 font-medium max-w-2xl mt-10 border-l-4 border-orange-500 pl-6"
          >
          ...
          >
            <Link href="/apply" className="group flex items-center justify-center gap-3 bg-orange-500 hover:bg-orange-600 text-black font-bold text-lg md:text-xl px-8 md:px-10 py-4 md:py-5 transition-all duration-300">
      ...
      <section className="w-full py-32 px-4 md:px-12 bg-black relative z-10 border-t border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tight">Our <span className="text-orange-500">Arsenal.</span></h2>
      ...
      <section className="w-full py-32 px-4 md:px-12 bg-black border-y border-white/10 overflow-hidden relative z-10">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-end">
            <div>
              <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tight">The Blueprint.</h2>
              <p className="text-lg md:text-xl text-gray-400 mt-4 font-medium">A clear, aggressive path to scaling operations without the fluff.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-zinc-900 border border-white/10 p-6 md:p-10 hover:bg-zinc-800 transition-colors group"
              >
                <div className="text-5xl md:text-6xl font-black text-white/10 group-hover:text-orange-500/20 transition-colors mb-6">{item.step}</div>
                <h4 className="text-xl md:text-2xl font-black uppercase text-white mb-4 border-l-2 border-orange-500 pl-3">{item.title}</h4>
                <p className="text-sm md:text-base font-medium text-gray-400">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full py-40 px-4 md:px-12 relative overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-black/90 z-10" />
          <img src={images.results} alt="Client Results" className="w-full h-full object-cover filter grayscale" />
        </div>

        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tight">Social <span className="text-orange-500">Proof.</span></h2>
            <p className="text-lg md:text-xl text-gray-400 mt-4 font-medium uppercase tracking-widest">Do not just take our word for it.</p>
          </div>
      ...
      <section className="w-full py-48 px-4 md:px-12 text-center relative overflow-hidden bg-orange-500 text-black border-t border-black">
        ...
        <div className="max-w-4xl mx-auto relative z-20">
          <h2 className="text-4xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9] mb-8">
            Are You <br /> Ready To Scale?
          </h2>
          <p className="text-lg md:text-3xl font-bold mb-12 leading-tight max-w-3xl mx-auto opacity-80">
            This invitation is strictly for serious business owners ready to grow out of their current plateau.
          </p>

          <Link href="/apply" className="inline-flex items-center justify-center gap-3 bg-black text-white hover:bg-gray-900 font-black uppercase tracking-widest text-lg md:text-xl px-10 md:px-12 py-5 md:py-6 transition-all duration-300 hover:scale-105 border-4 border-transparent shadow-[0_0_50px_rgba(0,0,0,0.5)]">
